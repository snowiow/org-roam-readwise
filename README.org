...
The package will create a new directory in your =org-roam-directory= called =readwise=. In there you will find different subdirectories for articles, books etc.
