...
#+begin_src emacs-lisp
C-u M-x org-roam-readwise-sync
#+end_src

* Features
** Markdown to Org-mode conversion
Readwise content (highlight text, notes, and book summaries) often contains Markdown formatting. =org-roam-readwise= automatically converts this to the equivalent Org-mode syntax on import, including links, bold, italic, inline code and strikethrough.
